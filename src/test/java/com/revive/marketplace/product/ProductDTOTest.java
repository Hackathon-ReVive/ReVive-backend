...
class ProductDTOTest {
    ...
    void setUp() {
        ...
        productModel.setTitle("Laptop");
        productModel.setDescription("High-performance laptop");
        productModel.setPrice(BigDecimal.valueOf(1200.99));
        productModel.setImage("laptop.jpg");
        productModel.setCategory(ProductCategory.ELECTRONICS);
        productModel.setStatus(ProductStatus.AVAILABLE);
        productModel.setLiked(false);
        productModel.setUser(mockUser);
